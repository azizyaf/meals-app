...
const MealDetailScreen = props => {
  ...
  // check if meal is in favoriteMeals
  ...
  return (
    <ScrollView>
      ...
      {selectedMeal.ingrediants.map(ing => (
...
// we can only use hooks inside of other hooks or inside a function component therefore can't use useSelector in here
